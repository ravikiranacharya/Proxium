...
Class SparkControlBox
    ...
    Private _IsMaximizable, _IsMinimizable, _IsClosable As Boolean
    Property IsMaximizable As Boolean
        Get
        ...
        End Set
    End Property
    Property IsMinimizable As Boolean
        Get
            Return _IsMinimizable
        End Get
        Set(value As Boolean)
        ...
        End Set
    End Property
    Property IsClosable As Boolean
        Get
            Return _IsClosable
        End Get
        Set(value As Boolean)
...
Public Class SparkGroupBox
    ...
    Public Overloads Overrides Sub OnPaint(e As GroupBoxPaintEventArgs)
        ...
        G.FillRectangle(GetBrush(BorderColor), ClientRectangle)
        G.DrawRectangle(GetPen(BorderColor), ClientRectangle)
    ...
    Protected Overrides Sub OnPaint(e As PaintEventArgs)
        ...
        For TabItemIndex As Integer = 0 To TabPages.Count - 1
            ...
            If SelectedIndex = TabItemIndex Then
                ...
                G.FillRectangle(GetBrush(Color.White), New Rectangle(ItemRectangle.X + ItemRectangle.Width / 4.0F, ItemRectangle.Height - 3, ItemRectangle.Width / 2.0F, 2))
            End If
...
Public Class SparkFloatingActionButton
    Inherits MintButton
    ...
    Public Overloads Overrides Sub OnPaint(e As ButtonPaintEventArgs)
        ...
        Path1 = PathHelper.FilletRectangle(GroupRectangle, BorderRadius * 2.0F, CornerAlignment.All)
        Path2 = PathHelper.FilletRectangle(BorderRectangle, BorderRadius * 2.0F, CornerAlignment.All)
        Select Case e.MouseState
            Case MouseState.MouseDown
                G.FillEllipse(GetBrush(ButtonClickColor), GroupRectangle)
            Case MouseState.MouseOver
                G.FillEllipse(GetBrush(HoverColor), GroupRectangle)
            Case Else
                G.FillEllipse(GetBrush(BackColor), GroupRectangle)
        End Select
        G.DrawEllipse(GetPen(BorderColor), GroupRectangle)
...
Public Class SparkToast
    ...
    Private _PopupStyle As PopupStyle
    Property Style As PopupStyle
        Get
            Return _PopupStyle
        End Get
        Set(value As PopupStyle)
            _PopupStyle = value
            Invalidate()
        End Set
    End Property
    ...
    Protected Overrides Sub OnPaint(e As PaintEventArgs)
        ...
        Select Case Style
            Case PopupStyle.Information
                ...
                G.FillEllipse(GetBrush(ForeColor), New Rectangle(0, 0, Height - 1, Height - 1))
                TextRenderer.DrawText(G, "ü", New Font("Wingdings", Height / 2.0F, FontStyle.Regular), New Point(2, 2), Color.White)
                TextRenderer.DrawText(G, Text, New Font("Segoe UI", Height / 2.0F), New Point(Height + 1, 1), ForeColor)
            ...
            Case PopupStyle.Warning
                ...
                G.FillEllipse(GetBrush(ForeColor), New Rectangle(0, 0, Height - 1, Height - 1))
                TextRenderer.DrawText(G, "S", New Font("Wingdings", Height / 2.0F, FontStyle.Regular), New Point(2, 2), Color.White)
                TextRenderer.DrawText(G, Text, New Font("Segoe UI", Height / 2.0F), New Point(Height + 1, 1), ForeColor)
            Case PopupStyle.Critical
                ForeColor = Color.Red
                G.FillEllipse(GetBrush(ForeColor), New Rectangle(0, 0, Height - 1, Height - 1))
                TextRenderer.DrawText(G, "S", New Font("Wingdings", Height / 2.0F, FontStyle.Regular), New Point(2, 2), Color.White)
                TextRenderer.DrawText(G, Text, New Font("Segoe UI", Height / 2.0F), New Point(Height + 1, 1), ForeColor)
